...
include "header.php";
			...
			<div class="container">    
				<div class="col-sm-12">                   			
					...
					$req=$_POST["seat"];
					$sel="SELECT * FROM `bus` where board_point='".$_POST["boardPoint"]."' and drop_point='".$_POST["dropPoint"]."' and date='".$_POST["date"]."' and seats_available>= ".$_POST["seat"]."  " ;
	...
	//echo $Bus_id;         
							...
							echo "<td><a href='busReviews.php?Seats_no={$req}& Bus_id={$Bus_id}& Total_fare={$Total_fare}' class='btn btn-primary'> Book</a></td>";
	/*echo
