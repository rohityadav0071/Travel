...
<div id="printarea">
<?php
          $sel="SELECT * FROM `bus` where id={$_POST["bid"]}";
...
$newseat=$aseat-$_POST['noofseat'];

$up="UPDATE bus SET seats_available={$newseat} WHERE id={$bid}";
...
// $insert="INSERT INTO `booking_details` (`journey_date`, `fare`, `no_of_passenger`, `passenger_name`, `passenger_phone`, `payment_status`, `pnr`, `seat_no`, `status`, `transaction_id`, `bus_id`, `user_id`, `pick_up`, `board_point`, `drop_point`, `bus_no`, `booking_date`) VALUES ('{$jdate}', '{$_POST["\ totalfare"\]}', '{$_POST["\ noofseat"\]}', '{$_POST["\ name "\]}', '$_POST["\phone "\]', 'TRUE', '$_POST["\ pnr"\]', '{$booked_seats}', 'TRUE', '{$_POST["\ tran "\]}', '{$bid}', '{$_SESSION["\ id "\]}', '{$brdtm}', '{$brdpnt}', '{$drppnt}', '{$breg}', '{$dt}')";
