...
<?php 
            if (isset($_POST['send'])) {
               ...
               $sql = "INSERT INTO `feedback` (`name`, `email`, `subject`, `feedback`) VALUES ('{$_POST['userName']}', '{$_POST['userEmail']}', '{$_POST['subject']}', '{$_POST['content']}')";
...
<body style="width:100%">
   <div class="form-container" style="margin-left:30%; width: 40%; margin-top: 5%">
	  <h3>FEEDBACK FORM</h3>
        <form name="frmContact" action="feedback.php" method="post"
            ...
            <div class="input-row">
                <label>Feedback:</label> <span id="userMessage-info"
                    class="info"></span><br />
